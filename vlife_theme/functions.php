...
function register_acf_block_types() {
  ...
  acf_register_block_type(array(
      ...
      'render_template'   => 'block/block-columns.php',
      'category'          => 'layout',
      'icon'              => 'book-alt',
  ...
  acf_register_block_type(array(
      'name'              => 'bg left block',
      'title'             => __('bg-left-block'),
      'description'       => __('A custom gradient left block.'),
      'render_template'   => 'block/bg-left-block.php',
      'category'          => 'layout',
      'icon'              => 'book-alt',
  ...
  acf_register_block_type(array(
      'name'              => 'bg right block',
      'title'             => __('bg-right-block'),
      'description'       => __('A custom gradient right block.'),
      'render_template'   => 'block/bg-right-block.php',
      'category'          => 'layout',
      'icon'              => 'book-alt',
      'keywords'          => array( 'gradient right block', 'quote' ),
  ));

  // register two corners block
  acf_register_block_type(array(
    'name'              => 'Two corners block',
    'title'             => __('Two Corners block'),
    'description'       => __('A custom corners block.'),
    'render_template'   => 'block/two-corners.php',
    'category'          => 'layout',
    'icon'              => 'book-alt',
    'keywords'          => array( 'corner block', 'quote' ),
));

// register border block
acf_register_block_type(array(
  'name'              => 'Border block',
  'title'             => __('Border block'),
  'description'       => __('A custom corners block.'),
  'render_template'   => 'block/border-block.php',
  'category'          => 'layout',
  'icon'              => 'book-alt',
  'keywords'          => array( 'border block', 'quote' ),
));
}
