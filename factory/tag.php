...
<div class="content work-content">
	<div class="tab-wrap">
		...
		<ul class="tab-list">
			<?php foreach ($tags as $tag) { ?>
				<li class="tab">
					<a href="<?php echo esc_url(get_tag_link($tag->term_id)); ?>" title="<?php echo esc_attr($tag->name); ?>" class="tab-link">
	...
	<div class="inner" id="tab-content">
		<div class="work-list">
			<?php
			global $query_string;
			$posts = query_posts($query_string . '&post_type=work');
				...
				<div class="work">
					<a href="<?php the_permalink(); ?>">
						...
						<div class="work-txt">
							...
							<div class="work-desc s-pc"><?php the_field('work-desc'); ?></div>
							<ul class="badge-list">
								<?php
